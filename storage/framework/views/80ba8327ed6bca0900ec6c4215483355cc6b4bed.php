        ...
        <div class="row">
            <div class="col-md-8">
                <section class="status_form">
                    <?php echo $__env->make('shared.status_form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </section>
                <h3>微博列表</h3>
                <?php echo $__env->make('shared/feed', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
